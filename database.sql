-- https://github.com/jackc/pgx/blob/master/examples/url_shortener/structure.sql
...
CREATE TRIGGER trigger_test_genid BEFORE INSERT ON shortened_urls FOR EACH ROW EXECUTE PROCEDURE unique_short_id();